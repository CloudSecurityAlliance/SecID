...
The resolver is live at secid.cloudsecurityalliance.org with 2,134 namespaces across 10 types. The grammar, type list, and registry format are frozen for v1.0. Post-1.0 work continues on the Relationship Data Layer and Data Enrichment Layer (parallel research tracks).
...
│   ├── <type>/<tld>/<domain>.json  # JSON format (2,134 namespaces — 100% coverage)
