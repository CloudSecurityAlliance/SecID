...
- Pilot .json files as worked examples:
  - `registry/advisory/org/mitre.json` — Simple advisory source
  ...
  - `registry/weakness/org/owasp.json` — `version_required` and `version_disambiguation` example
